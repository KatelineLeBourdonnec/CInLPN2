...
CInLPN2_estimand <- function(structural.model, measurement.model, parameters, 
  ...
  est <- CInLPN2.default.estimand(fixed_X0.models = fixed_X0.models, fixed_DeltaX.models = fixed_DeltaX.models, randoms_X0.models = randoms_X0.models, 
  ...
  cat("The program took ENVIRON:", p.time[1], "\n")
  est
}
